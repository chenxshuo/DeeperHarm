...
async def main_async():
    ...
    if args.single_question:
        ...
        # Process special fields for strongreject and scisafeeval datasets
        if args.dataset_name == 'strongreject':
            ...
            # Use forbidden_prompt field as Question field for SciSafeEval dataset
            for item in filtered_data:
                if 'forbidden_prompt' in item and 'Question' not in item:
                    item['Question'] = item['forbidden_prompt']
            print('Note: The forbidden_prompt field in SciSafeEval dataset has been processed as Question')
