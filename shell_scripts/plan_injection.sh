# 1. run the server: 
nohup vllm serve Qwen/QwQ-32B --dtype auto --api-key token-abc123 --tensor-parallel-size 2 > server-qwq-32-plan-injection.log 2>&1 &
...
#       --output_dir "" \
#       --dataset "data/SciSafeEval/PlanInjection.json"
