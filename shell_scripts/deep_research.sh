...
# 1. run the server: 
## Inference Models: Qwen/QwQ-32B, Qwen/Qwen3-32B
# nohup vllm serve Qwen/Qwen3-32B --dtype auto --api-key token-abc123 --tensor-parallel-size 2 > server.log 2>&1 &

## Large Models: deepseek-ai/DeepSeek-R1-Distill-Llama-70B, Qwen/Qwen2.5-72B-Instruct
...
## RL Models: GAIR/DeepResearcher-7b, Qwen/Qwen2.5-7B-Instruct
